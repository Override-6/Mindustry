...
import mindustry.linkit.MindustryObjectReference;
...
public class Weapon implements Cloneable {
    ...
    private final MindustryObjectReference reference;

    //@Persist(inherit = true)
    public Weapon(String name) {
        this.name = name;
        this.reference = new MindustryObjectReference("weapon/" + name);
    }
    ...
    /*@Override
    public MindustryObjectReference reference() {
        return reference;
    }
